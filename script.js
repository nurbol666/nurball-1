...
const handleYesClick = () => {
  question.innerHTML = "Yeahhhhhhhhhhh! I love you so much!I had no doubt!!";
  gif.src = "https://media.tenor.com/P-VyTymrVJgAAAAi/bubu-dudu.gif";
  ...
  letsGoBtn.addEventListener("click", () => {
    ...
    alert(`Message from you DUDU : ${selectedDateIdea}`);
  });
